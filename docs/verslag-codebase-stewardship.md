...
## Welke vorm van open source is OpenZaak?
...
Dit is de reden dat deze gemeenschap geen typische open community-governance heeft – het bestuur wordt uitgevoerd door landelijke regie om samenwerking in exploitatie en samenhang tussen componenten te waarborgen.
...
Er is wel een zekere hybriditeit. Voor sommige componenten kan
...
In dat geval moet worden geëvalueerd of deelname aan de samenwerking voordelig is voor de codebase (meer mensen investeren erin) of juist een remmende factor is (meer complexiteit dan het waard is). Dit zal per component/gemeenschap beoordeeld moeten worden.
