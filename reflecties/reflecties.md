---
layout: default
title: Reflecties op dit project
parent: Reflecties
nav_order: 1
---
...
Andere Common Ground-componenten kunnen mogelijk een veel groter potentieel hebben voor herbruikbaarheid en schaalbaarheid. In dat geval kan investeren in de overhead van open governance en communitymanagement juist goede rendementen opleveren in de vorm van bijdragen van hergebruikende organisaties en communityleden. Dat is de ware kracht van open source.
...
Sommige componenten hebben potentieel voor hergebruik buiten de gemeentelijke context. Dat lijkt momenteel geen prioriteit, maar is wel een van de fundamentele uitgangspunten van open source werken en kan veel opleveren in termen van innovatie en kwaliteit.

Het is lastig vooraf te bepalen uit welke hoek dergelijk hergebruik kan ontstaan. Juist daarom is het belangrijk om open te blijven staan voor signalen en verzoeken van buiten het huidige netwerk.
